package com.products.api.runner;

import com.products.api.config.Config;
...
@CucumberOptions(
		...
		features = "src/test/java/com/products/api/features",
		glue={"com.products.api.stepdefinitions", "com.products.api.hooks"},
		strict = true,
		dryRun = false
)
